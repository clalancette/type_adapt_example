...
template<>
struct rclcpp::TypeAdapter<type_adapt_example::ROSCvMatContainer, sensor_msgs::msg::Image>
{
  using is_specialized = std::true_type;
  using custom_type = type_adapt_example::ROSCvMatContainer;
  ...
  {
    destination = type_adapt_example::ROSCvMatContainer(source);
  }
};
